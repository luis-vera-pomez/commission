...
Team.create!(title: 'Life Insurance Team', description: nil, location: 'South')
Team.create!(title: 'Telemarketing Insurance Team', description: nil, location: 'East')
Team.create!(title: 'Virtual Insurance Team', description: nil, location: 'West')
