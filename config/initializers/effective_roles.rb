EffectiveRoles.setup do |config|
  config.roles = [:admin, :supervisor, :agent] # Only add to the end of this array.  Never prepend roles.
  ...
  #
  config.role_descriptions = {
    :admin => 'full access to website content. Can manage users and all website content.',
    :supervisor => 'cannot access admin area. Can see all content in supervisors and agents sections of the website.',
    :agent => 'cannot access admin area. Can see all content in agents-only sections of the website.'
  }
